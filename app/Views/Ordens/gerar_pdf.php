...
<div id="body-pdf">
  <div>
    ...
    <p><strong class="color">Ordem aberta por: </strong><?php echo esc($ordem->usuario_abertura) ?></p>
    <p><strong class="color">Responsável técnico: </strong><?php echo esc(($ordem->usuario_responsavel != null ? $ordem->usuario_responsavel : 'Não definido')) ?></p>

    <?php if ($ordem->situacao === 'encerrada') : ?>
      <p><strong class="color">Ordem encerrada por: </strong><?php echo esc($ordem->usuario_encerramento) ?></p>
    <?php endif; ?>
