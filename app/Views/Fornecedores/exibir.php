...
<div class="row">
  <div class="col-lg-3">
    <div class="user-block block">
      ...
      <h5 class="cart-title mt-2"><?php echo esc($fornecedor->razao); ?></h5>
      ...
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="<?php echo site_url("fornecedores/notas/$fornecedor->id"); ?>">Gerenciar as notas fircais</a>
          ...
          <?php else : ?>
            <a class="dropdown-item" href="<?php echo site_url("fornecedores/desfazerexclusao/$fornecedor->id"); ?>">Recuperar fornecedor</a>
          <?php endif; ?>
