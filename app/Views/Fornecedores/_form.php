<div class="row">
  ...
  <div class="form-group col-6">
    ...
    <input type="text" name="nome_fantasia" placeholder="Insira o nome fantasia" class="form-control" value="<?php echo esc($fornecedor->nome_fantasia); ?>">
  </div>
  ...
  <div class="form-group col-4">
    ...
    <input type="text" name="ie" placeholder="Insira a inscrição estadual" class="form-control" value="<?php echo esc($fornecedor->ie); ?>">
  </div>
