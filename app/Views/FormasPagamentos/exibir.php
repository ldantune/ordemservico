...
<div class="row">
  ...
  <?php if ($forma->id == 1) : ?>
    <div class="col-md-12">
      <div class="alert alert-info" role="alert">
        ...
        <p>A forma de pagamento <b><?php echo esc($forma->nome) ?></b> não pode ser editada ou excluída,
          pois a mesma poderá ser associada as ordens de serviço.</p>
        <hr>
        <p class="mb-0">Não se preocupe, pois as demais formas de pagamento podem ser editadas ou removidas conforme se fizer necessário.</p>
      </div>
    </div>
  <?php endif; ?>
  ...
  <?php if ($forma->id == 2) : ?>
    <div class="col-md-12">
      <div class="alert alert-info" role="alert">
        <h4 class="alert-heading">Importante!</h4>
        <p>A forma de pagamento <b><?php echo esc($forma->nome) ?></b> não pode ser editada ou excluída,
          pois a mesma será associada as ordens de serviço que não gerarem valor.</p>
        <hr>
        <p class="mb-0">Não se preocupe, pois as demais formas de pagamento podem ser editadas ou removidas conforme se fizer necessário.</p>
      </div>
    </div>
  ...
  <div class="col-lg-3">
    ...
    <div class="user-block block">
      ...
      <h5 class="cart-title mt-2"><?php echo esc($forma->nome); ?></h5>
